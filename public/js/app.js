		...
		return React.createElement(
			...
			React.createElement(
				...
				this.props.users.map(function (user, i) {
					return React.createElement(
						'div',
						{ key: i, className: 'cases' },
						React.createElement(
							'div',
							{ className: 'foto' },
							React.createElement('img', { src: 'img/user_online.png' })
						),
						React.createElement(
							'div',
							{ className: 'nombre' },
...
var Message = React.createClass({
	...
	render: function render() {
		return React.createElement(
			'div',
			{ className: 'mensajeChat' },
			React.createElement(
				'div',
				{ className: 'nombremensaje' },
				this.props.user
			),
			this.props.text
		);
...
var ChatApp = React.createClass({
	...
	_messageRecieve: function _messageRecieve(message) {
		var myNotification = new Notify(message.user, {
			body: message.text,
			tag: message.user,
			timeout: 5,
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: 'table-cell fixed-width-200' },
				React.createElement('div', { ref: function (ref) {
						return _this2._div = ref;
					} }),
